...
if __name__ == '__main__':
    ...
    args.log_name=args.log_name+'_warmup_proportion_{}_ce_continue_cl_{}_seed_{}_train_batch_size_{}_lr_{}_temperatue_{}_alpha_{}_a1_{}_a2_{}' \
    ...
    os.system(command) #将f1文件内容复制到这个checkpoint文件
    command = "cp -r " + f2 + " " + 'new_log/'+args.log_name+'implicit_model.py' #将f2文件内容复制到这个checkpoint文件
